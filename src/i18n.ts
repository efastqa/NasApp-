...
export const translations: Record<Language, TranslationDict> = {
  en: {
    ...
    resetAdminPinDesc: 'Enter the master security recovery key to authorize setting a new admin password',
    masterRecoveryKey: 'Master Recovery Key',
    enterMasterKey: 'Enter Master Security Key or Admin Email',
    masterKeyPlaceholder: 'Enter Master Security Key',
  ...
  ar: {
    ...
    resetAdminPinDesc: 'أدخل مفتاح الأمان الرئيسي المعتمد لتعيين رمز مرور جديد للمشرف',
    masterRecoveryKey: 'مفتاح الاستعادة الرئيسي',
    enterMasterKey: 'أدخل مفتاح الأمان الرئيسي أو بريد المشرف',
    masterKeyPlaceholder: 'أدخل مفتاح الأمان الرئيسي',
